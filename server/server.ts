...
if (!isProduction) {
  ...
  app.use(
    '/',
    (await import('sirv')).default('./dist/client', { extensions: [] })
  );
}
...
app.post(
  ...
  (await import('./routes/login')).router
);
app.use(
  '/student',
  authenticateToken,
  (await import('./routes/database/student')).router
);
app.use(
  '/teacher',
  authenticateToken,
  (await import('./routes/database/teacher')).router
);
app.use(
  '/user',
  authenticateToken,
  (await import('./routes/database/user')).router
);
app.use(
  '/course',
  authenticateToken,
  (await import('./routes/database/course')).router
);
app.use(
  '/attendance',
  authenticateToken,
  (await import('./routes/database/attendance')).router
);
app.use(
  '/schedule',
  authenticateToken,
  (await import('./routes/database/schedule')).router
);
app.use(
  '/class',
  authenticateToken,
  (await import('./routes/database/class')).router
);
app.use(
  '/exam',
  authenticateToken,
  (await import('./routes/database/exam')).router
);
app.use(
  '/lesson',
  authenticateToken,
  (await import('./routes/database/lesson')).router
);
app.use(
  '/result',
  authenticateToken,
  (await import('./routes/database/result')).router
);
app.use(
  '/report',
  authenticateToken,
  (await import('./routes/database/report')).router
);
app.use(
  '/notification',
  authenticateToken,
  (await import('./routes/database/notification')).router
);
app.use(
  '/analytics',
  authenticateToken,
  (await import('./routes/analytics')).router
);
